  ...
  return (
    <div className="p-6 max-w-6xl">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-lg font-semibold">Exceptions</h1>
        <button
          onClick={load}
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 w-full max-w-md">
            ...
            {(actionStatus === 'resolved' || actionStatus === 'closed') && (
              <textarea
                ...
                rows={3}
                className="w-full text-sm bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-slate-200 mb-4 focus:outline-none focus:border-indigo-500"
              />
            )}
